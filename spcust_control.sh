...
initCustom()
{
    ...
    echo "Init custom..."
    # rm -rf /home/control/cdunix/ndm/secure+/nodes
}
...
invokeCLI()
{
    /home/control/cdunix/ndm/bin/spcli.sh -e 8 -li y << EOF
    ;
    display info
    ;
    ;
    ...
    ;
    sync netmap 
        path=/home/control/cdunix/ndm/cfg/control/netmap.cfg
        name=*
    ;
    ;
    ; -- Import KeyCert
    ;
    Import KeyCert
        File=/home/control/cdunix/ndm/secure+/certificates/keycert
        Passphrase=P@ssw0rd
        Label=control
        ImportMode=Add
    ;
    ...
    ;
    Import TrustedCert
        File=/home/control/cdunix/ndm/secure+/certificates/cert
        ImportMode=Add
    ;
    ;
    ; -- Update LocalNode
